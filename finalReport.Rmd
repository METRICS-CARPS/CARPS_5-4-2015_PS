...
We observe minor errors but no major errors in the descriptive statistics.
...
#here there is a mis-match for the mean- is there a missing/extra participant?
...
reportObject <- reproCheck(reportedValue = "5.76", obtainedValue = F_budget_account, valueType = 'F') #F-statistic
reportObject <- reproCheck(reportedValue = ".07", obtainedValue = pes_budget_account, valueType = 'pes') #partial effect size
```
